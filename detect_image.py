...
parser.add_argument('--weights', default=r"C:/Users/86178/Desktop/multispectral-yolov11-transformer/runs/train/exp12/weights/best.pt", type=str, help='weights path')
parser.add_argument('--image_rgb', default=r"D:/drone_data/dataset/rgb_aligned/val/images", type=str,
                    help='image_rgb')
parser.add_argument('--image_ir', default=r"D:/drone_data/dataset/ir_aligned/val/images", type=str,
                    help='image_ir')
...
parser.add_argument('--save_image', default=r".C:/Users/86178/Desktop/bs", type=str, help='save img or video path')
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            for *xyxy, conf, cls in reversed(det):
                ...
                cv2.putText(img_vis_ir, f"{self.names[int(cls)]}/{conf:.1f}", (int(xmin), int(ymin - 5)),
                            cv2.FONT_HERSHEY_COMPLEX, 0.5, get_color(int(cls) + 2), thickness=2)
        return img_vis, img_vis_ir, all_detections
...
if __name__ == '__main__':
    ...
    images_format = ['.png', '.jpg', '.txt', '.jpeg', 'JPG']
    ...
    for i, img_name in enumerate(image_names):
        ...
        #add
        height1, width1 = img_rgb.shape[:2]
        height2, width2 = img_ir.shape[:2]
        target_size = (768, 432)
        # target_size= (700,500)
        ...
        #add end
        img_vi, img_ir, detections = detector(img_rgb, img_ir, opt.conf_thre, opt.iou_thre)
        ...
        if opt.vis:
            cv2.imshow('detection', img_combined)
            cv2.waitKey(0)

...
# FQY ćĺťşéćşéć ˇçsamplerďźä¸şäşäšĺĺć¨Ąćčžĺ?
...
def load_mosaic_RGB_IR(self, index1, index2):
    ...
    assert index_rgb == index_ir, 'INDEX RGB ä¸ç­äş? INDEX IR'
    ...
    # assert labels4_rgb == labels4_ir, 'LABEL4 RGB ä¸ç­äş? LABEL4 IR'
